...
if __name__ == "__main__":
    ...
    cache_settings = pyspark.StorageLevel.MEMORY_AND_DISK_2 #Χρησιμοποιείται η αποθήκευση στην προσωρινή μνήμη αλλά και στον δίσκο
    ...
    if "local" not in local_check:
        ...
        model_path = "/trained_models/" #"user/" + hadoopuser + "/trained_models/" # Το σημείο στο hdfs που θα αποθηκευτούν τα δεδομένα από το μοντέλο αξιολόγησης   
        model_full_path = hdfs_root + model_path + modelname + ".pkl" # Ολόκληρο το μονοπάτι του hdfs που θα αποθηκευτούν τα δεδομένα από το μοντέλο αξιολόγησης.
        ...
        ldir = "./" + filename + "_results/" # Το directory που θα χρησιμοποιηθεί για εκτέλεση σε local mode
